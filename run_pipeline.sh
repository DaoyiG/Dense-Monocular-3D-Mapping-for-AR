...
echo "===================================="
cp -r $HOME/Dense-Monocular-3D-Mapping-for-AR/assets/test_images/ $HOME/Dense-Monocular-3D-Mapping-for-AR/assets/output_rgb_infinitam/
...
cp -r $HOME/Dense-Monocular-3D-Mapping-for-AR/assets/test_images/ $HOME/Dense-Monocular-3D-Mapping-for-AR/o3d/ReconstructionSystem/dataset/kitti_0/image/
cp -r $HOME/Dense-Monocular-3D-Mapping-for-AR/assets/output_depth_o3d/ $HOME/Dense-Monocular-3D-Mapping-for-AR/o3d/ReconstructionSystem/dataset/kitti_0/depth/
...
echo "===================================="
cd $HOME/Dense-Monocular-3D-Mapping-for-AR/o3d/ReconstructionSystem/ && python run_system.py $HOME/Dense-Monocular-3D-Mapping-for-AR/o3d/ReconstructionSystem/config/kitti_0.json --make --register --refine --integrate
...
./InfiniTAM $HOME/Infinitam_kitti/InfiniTAM/kitti/calib6.txt $HOME/Dense-Monocular-3D-Mapping-for-AR/assets/output_rgb_infinitam/%04i.ppm $HOME/Dense-Monocular-3D-Mapping-for-AR/assets/output_depth_infinitam/%04i.pgm
